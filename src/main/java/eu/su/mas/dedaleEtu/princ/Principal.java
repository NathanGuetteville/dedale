...
//		agentList.add(ag);	
		 ...
		 * entityParametersExplo1); ag=createNewDedaleAgent(c, agentName,
		 * ExploreCoopAgent.class.getName(), entityParametersExplo1);//ExploreSoloAgent
		 * agentList.add(ag);
		 */
